...
object MyML7 {
  ...
  def main(args: Array[String]): Unit = {
    ...
    //    划分训练集
    val Array(train, test) = data2.randomSplit(Array(0.7, 0.3))
    ...
    val pipline = new Pipeline()
      .setStages(Array(tokenizer, remover, hashingTF, idf, labelIndexer1, labelIndexer2, assembler, labelIndexer, featureIndexer, gbdt, labelConverter))
